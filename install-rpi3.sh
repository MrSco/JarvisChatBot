...
if ! command -v ./piper/piper &> /dev/null; then
    ...
    curl -L https://github.com/rhasspy/piper/releases/download/v1.2.0/piper_armv7.tar.gz -o piper_armv7.tar.gz

    # extract the binary
    tar -xvzf piper_armv7.tar.gz

    # remove the tar.gz file
    rm piper_armv7.tar.gz
...
if [ ! -f piper_models/vasco.onnx ]; then
    # download the model
    curl -L https://huggingface.co/poisson-fish/piper-vasco/resolve/main/onnx/vasco.tar.gz?download=true -o piper_models/vasco.tar.gz
